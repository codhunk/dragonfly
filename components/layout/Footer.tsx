    ...
    <footer className="bg-[#efe8ce] w-full pt-16 pb-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-4 md:px-16 max-w-7xl mx-auto">
        <div className="space-y-4">
          <div className="text-xl font-bold text-[#72544e] font-bold">DragonFly</div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-16 mt-16 pt-8 border-t border-[#72544e]/10 text-center space-y-2">
        <p className="text-[#72544e] text-base font-body">© {new Date().getFullYear()} DragonFly. Crafted for Connoisseurs.</p>
        <p className="text-[#72544e] text-sm font-bold">Managed by <Link href="https://webduality.in" className="text-primary">WebDuality</Link></p>
      </div>
    </footer>
  );
}
