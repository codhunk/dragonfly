      ...
      <div className="space-y-16">
        <section className="text-center max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-base italic leading-none tracking-normal text-tertiary">
            At The Modern Gastronome, we don't just hire employees; we recruit culinary visionaries and hospitality experts. We believe that a great workplace is built on the foundation of shared excellence and the pursuit of perfection.
          </p>
        </section>

        <section className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {perks.map((perk, idx) => (
                <div key={idx} className="bg-primary/5 rounded-xl p-8 border border-primary/10 hover:shadow-lg transition-shadow">
