      ...
      <div className="space-y-16">
        <section className="text-center max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-base italic leading-none tracking-normal text-tertiary">
                At The Modern Gastronome, we believe that nutrition should never be an afterthought. Every ingredient is selected for its flavor, its origin, and its nutritional value. We provide full transparency because your body deserves to know what fuels its sensory experiences.
            </p>
        </section>

        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {dietaryOptions.map((opt, idx) => (
                <div key={idx} className="flex gap-6 p-8 rounded-xl bg-primary/5 hover:bg-primary/10 transition-colors border border-primary/10">
