...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-background text-on-surface selection:bg-primary/20 selection:text-primary">
      ...
      {/* Brand Story Section */}
      <section className="py-16 md:py-32 bg-surface px-4 md:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 lg:-bottom-10 lg:-right-10 w-48 h-48 md:w-64 md:h-64 rounded-[1.5rem] overflow-hidden border-8 border-surface hidden sm:block shadow-xl">
              <Image 
      ...
      <section className="py-16 md:py-32 bg-surface-container px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <motion.div 
                ...
                viewport={{ once: true }}
                className="md:col-span-2 bg-surface-container-lowest p-8 md:p-12 rounded-[2rem] flex flex-col justify-between shadow-sm"
            >
              <div>
            ...
            <motion.div 
                ...
                className="bg-primary text-on-primary p-8 md:p-12 rounded-[2rem] shadow-ambient"
            >
      ...
      <section className="py-16 md:py-32 px-4 md:px-16 overflow-hidden">
      ...
      <section className="py-16 md:py-32 bg-surface-container-low px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="aspect-[3/4] rounded-[1.5rem] overflow-hidden mb-6 relative shadow-lg">
                <Image 
            ...
            <motion.div 
                ...
                className="col-span-1 sm:col-span-2 lg:col-span-2 relative rounded-[1.5rem] overflow-hidden shadow-2xl h-full min-h-[300px] md:min-h-[400px]"
            >
              <Image 
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 md:px-16 text-center bg-surface">
        <motion.div 
            initial={{ opacity: 0, scale: 0.95 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
